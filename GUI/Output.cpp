...
void Output::CreateDrawToolBar() const
{
	...
	MenuItemImages[ITM_BLACK] = "images\\MenuItems\\Black.jpeg";
	MenuItemImages[ITM_YELLOW] = "images\\MenuItems\\Yellow.jpeg";
	MenuItemImages[ITM_ORANGE] = "images\\MenuItems\\Orange.jpeg";
	...
	MenuItemImages[ITM_SELECT] = "images\\MenuItems\\Select.jpeg";
	...
	MenuItemImages[ITM_SEND] = "images\\MenuItems\\Send.jpg";
	MenuItemImages[ITM_BRING] = "images\\MenuItems\\Bring.jpg";
	MenuItemImages[ITM_SAVE] = "images\\MenuItems\\Save.jpg";
	MenuItemImages[ITM_LOAD] = "images\\MenuItems\\Load.jpg";
	MenuItemImages[ITM_SWITCH] = "images\\MenuItems\\Switch_play.jpg";
...
void Output::CreatePlayToolBar() const
{
	...
	MenuItemImages[PLAY_ITM_FIG] = "images\\MenuItems\\fig_type.jpg";
	MenuItemImages[PLAY_ITM_FILL] = "images\\MenuItems\\fill_color.jpg";
	MenuItemImages[PLAY_ITM_BOTH] = "images\\MenuItems\\fig_color.jpg";
	MenuItemImages[PLAY_ITM_RESTART] = "images\\MenuItems\\restart.jpg";
	MenuItemImages[PLAY_ITM_SWITCH] = "images\\MenuItems\\Switch_draw.jpg";
	MenuItemImages[PLAY_ITM_EXIT] = "images\\MenuItems\\Menu_Exit.jpg";

	for (int i = 0; i < PLAY_ITM_COUNT; i++)
		pWind->DrawImage(MenuItemImages[i], i * UI.MenuItemWidth,0, UI.MenuItemWidth, UI.ToolBarHeight);

	//clear remaining draw icons
...
void Output::DrawSqu(Point P1, int L, GfxInfo SquGfxInfo, bool selected) const
{
	color DrawingClr;
	if (selected)
		DrawingClr = UI.HighlightColor; //Figure should be drawn highlighted
	...
	if (SquGfxInfo.isFilled)
	{
		...
		style = FRAME;
	Point P2, P3;
	P2.x = P1.x - L; P2.y = P1.y - L;
	P3.x = P1.x + L; P3.y = P1.y + L;
...
void Output::DrawHex(Point P1, int L, GfxInfo HexGfxInfo, bool selected) const
{
	color DrawingClr;
	if (selected)
		DrawingClr = UI.HighlightColor; //Figure should be drawn highlighted
	...
	int Xpoints[6]; int Ypoints[6];
	Xpoints[0] = P1.x - L / 2; Ypoints[0] = P1.y - sqrt(3) * L / 2;
	Xpoints[1] = P1.x - L; Ypoints[1] = P1.y;
	Xpoints[2] = P1.x - L / 2; Ypoints[2] = P1.y + sqrt(3) * L / 2;
	Xpoints[3] = P1.x + L / 2; Ypoints[3] = P1.y + sqrt(3) * L / 2;
	Xpoints[4] = P1.x + L; Ypoints[4] = P1.y;
	Xpoints[5] = P1.x + L/2; Ypoints[5] = P1.y - sqrt(3)*L/2;
...
void Output::DrawCir(Point P1, Point P2, GfxInfo CirGfxInfo, bool selected) const
{
	...
	if (CirGfxInfo.isFilled)
	{
		...
		style = FRAME;
	int r = sqrt((int)pow((P2.x - P1.x), 2) + (int)pow((P2.y - P1.y), 2));
