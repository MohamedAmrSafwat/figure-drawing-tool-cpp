...
void CHexagon::Save(ofstream &outFile, int id) {
	outFile <<left <<setw(15) << "Hexagon" << setw(5) << id << setw(10) << Center.x << setw(10) << 
		Center.y << setw(10) << L<< setw(10) << "Draw color" << setw(10) << "Fill color" << endl;
}
void CHexagon::Load(ifstream& infile, int lineNum) {
